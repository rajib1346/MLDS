...
data_frame=pd.read_csv("C:/Users/acer/Downloads/11/processed_data.CSV")
data_frame
...
DataFrame=pd.read_csv("C:/Users/acer/Downloads/11/processed_data.csv")
...
x_train.to_csv('C:/Users/acer/Downloads/11/Initial_Train.csv')
x_test.to_csv('C:/Users/acer/Downloads/11/Initial_Test.csv')
...
train1=pd.read_csv("C:/Users/acer/Downloads/11/Train.CSV")
test1=pd.read_csv("C:/Users/acer/Downloads/11/1st_iteration/Test_1.csv")

x_train1 =train1[['age','chol','thalach','oldpeak','ca','thal']]
y_train1 = train1[['target']]

x_test1 = test1[['age','chol','thalach','oldpeak','ca','thal']]
...
if (acc_rf_1 > acc_naive_1 and acc_rf_1 > acc_gb_1) or (acc_rf_1==acc_naive_1 and acc_rf_1>acc_gb_1) or (acc_rf_1==acc_gb_1 and acc_rf_1>acc_naive_1) or (acc_naive_1==acc_gb_1 and acc_rf_1>acc_naive_1):
    ...
    FP_FN_RF_1.to_csv('C:/Users/acer/Downloads/11/2nd_iteration/Test_2.CSV')
    print("RF Provides best accuracy")
    print("rf_FP_FN: ",len(FP_FN_RF_1))
    
    TP_TN_RF_1=test1[test1['match']=='True']
    TP_TN_RF_1.to_csv('C:/Users/acer/Downloads/11/1st_iteration/1.CSV')
    TP_TN_RF_1=TP_TN_RF_1.drop(['rf_pre','match'], axis=1)
    TP_TN_RF_1.to_csv('C:/Users/acer/Downloads/11/1st_iteration/TN_TP_1.CSV')
    ...
    FP_FN_Na_1.to_csv('C:/Users/acer/Downloads/11/2nd_iteration/Test_2.CSV')
    print("Naive Bayes Provides best accuracy")
    print("na_FP_FN: ",len(FP_FN_Na_1))
    
    TP_TN_Na_1=test1[test1['match']=='True']
    TP_TN_Na_1.to_csv('C:/Users/acer/Downloads/11/1st_iteration/1.CSV')
    TP_TN_Na_1=TP_TN_Na_1.drop(['nb_pre','match'], axis=1)
    TP_TN_Na_1.to_csv('C:/Users/acer/Downloads/11/1st_iteration/TN_TP_1.CSV')
    ...
    FP_FN_gb_1.to_csv('C:/Users/acer/Downloads/11/2nd_iteration/Test_2.CSV')
    print("GB Provides best accuracy: ")
    print("gb_FP_FN: ",len(FP_FN_gb_1))
    
    TP_TN_gb_1=test1[test1['match']=='True']
    TP_TN_gb_1.to_csv('C:/Users/acer/Downloads/11/1st_iteration/1.CSV')
    TP_TN_gb_1=TP_TN_gb_1.drop(['gb_pre','match'], axis=1)
    TP_TN_gb_1.to_csv('C:/Users/acer/Downloads/11/1st_iteration/TN_TP_1.CSV')
...
train2=pd.read_csv("C:/Users/acer/Downloads/11/Train.CSV")
test2=pd.read_csv("C:/Users/acer/Downloads/11/2nd_iteration/Test_2.csv")

x_train2 =train2[['age','chol','thalach','oldpeak','ca','thal']]
y_train2 = train2[['target']]

x_test2 = test2[['age','chol','thalach','oldpeak','ca','thal']]
...
if (acc_rf_2 > acc_naive_2 and acc_rf_2 > acc_gb_2) or (acc_rf_2==acc_naive_2 and acc_rf_2>acc_gb_2) or (acc_rf_2==acc_gb_2 and acc_rf_2>acc_naive_2) or (acc_naive_2==acc_gb_2 and acc_rf_2>acc_naive_2):
    ...
    FP_FN_RF_2.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/Test_3.CSV')
    print("RF Provides best accuracy")
    print("rf_FP_FN: ",len(FP_FN_RF_2))
    
    TP_TN_RF_2=test2[test2['match']=='True']
    TP_TN_RF_2.to_csv('C:/Users/acer/Downloads/11/2st_iteration/2.CSV')
    TP_TN_RF_2=TP_TN_RF_2.drop(['rf_pre','match'], axis=1)
    TP_TN_RF_2.to_csv('C:/Users/acer/Downloads/11/2nd_iteration/TN_TP_2.CSV')
    ...
    FP_FN_Na_2.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/Test_3.CSV')
    print("Naive Bayes Provides best accuracy")
    print("na_FP_FN: ",len(FP_FN_Na_2))
    
    TP_TN_Na_2=test2[test2['match']=='True']
    TP_TN_Na_2.to_csv('C:/Users/acer/Downloads/11/2nd_iteration/2.CSV')
    TP_TN_Na_2=TP_TN_Na_2.drop(['nb_pre','match'], axis=1)
    TP_TN_Na_2.to_csv('C:/Users/acer/Downloads/11/2nd_iteration/TN_TP_2.CSV')
    ...
    FP_FN_gb_2.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/Test_3.CSV')
    print("GB Provides best accuracy: ")
    print("gb_FP_FN: ",len(FP_FN_gb_2))
    
    TP_TN_gb_2=test2[test2['match']=='True']
    TP_TN_gb_2.to_csv('C:/Users/acer/Downloads/11/2nd_iteration/2.CSV')
    TP_TN_gb_2=TP_TN_gb_2.drop(['gb_pre','match'], axis=1)
    TP_TN_gb_2.to_csv('C:/Users/acer/Downloads/11/2nd_iteration/TN_TP_2.CSV')
...
train3=pd.read_csv("C:/Users/acer/Downloads/11/Train.CSV")
test3=pd.read_csv("C:/Users/acer/Downloads/11/3rd_iteration/Test_3.csv")

x_train3 =train3[['age','chol','thalach','oldpeak','ca','thal']]
y_train3 = train3[['target']]

x_test3 = test3[['age','chol','thalach','oldpeak','ca','thal']]
...
if (acc_rf_3 > acc_naive_3 and acc_rf_3 > acc_gb_3) or (acc_rf_3==acc_naive_3 and acc_rf_3>acc_gb_3) or (acc_rf_3==acc_gb_3 and acc_rf_3>acc_naive_3) or (acc_naive_3==acc_gb_3 and acc_rf_3>acc_naive_3):
    ...
    FP_FN_RF_3.to_csv('C:/Users/acer/Downloads/11/4th_iteration/Test_4.CSV')
    print("RF Provides best accuracy")
    print("rf_FP_FN: ",len(FP_FN_RF_3))
    
    TP_TN_RF_3=test3[test3['match']=='True']
    TP_TN_RF_3.to_csv('C:/Users/acer/Downloads/11/3st_iteration/3.CSV')
    TP_TN_RF_3=TP_TN_RF_3.drop(['rf_pre','match'], axis=1)
    TP_TN_RF_3.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/TN_TP_3.CSV')
    ...
    FP_FN_Na_3.to_csv('C:/Users/acer/Downloads/11/4th_iteration/Test_4.CSV')
    print("Naive Bayes Provides best accuracy")
    print("na_FP_FN: ",len(FP_FN_Na_3))
    
    TP_TN_Na_3=test3[test3['match']=='True']
    TP_TN_Na_3.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/3.CSV')
    TP_TN_Na_3=TP_TN_Na_3.drop(['nb_pre','match'], axis=1)
    TP_TN_Na_3.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/TN_TP_3.CSV')
    ...
    FP_FN_gb_3.to_csv('C:/Users/acer/Downloads/11/4th_iteration/Test_4.CSV')
    print("GB Provides best accuracy: ")
    print("gb_FP_FN: ",len(FP_FN_gb_3))
    
    TP_TN_gb_3=test3[test3['match']=='True']
    TP_TN_gb_3.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/3.CSV')
    TP_TN_gb_3=TP_TN_gb_3.drop(['gb_pre','match'], axis=1)
    TP_TN_gb_3.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/TN_TP_3.CSV')
...
knn_3=knn.predict(x_test3)
acc_knn_3=metrics.accuracy_score(y_test3,knn_3)*100

test3['knn_pre']=knn_3
test3['match'] = np.where(test3['target'] == test3['knn_pre'], 'True', 'False')
FP_FN_knn_3=test3[test3['match']=='False']
FP_FN_knn_3=FP_FN_knn_3.drop(['knn_pre','match'], axis=1)
FP_FN_knn_3.to_csv('C:/Users/acer/Downloads/11/4th_iteration/Test_4.CSV')
print("knn_1 Accuracy ",acc_knn_3)
print("knn_FP_FN: ",len(FP_FN_knn_3))
    
TP_TN_knn_3=test3[test3['match']=='True']
TP_TN_knn_3.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/3.CSV')
TP_TN_knn_3=TP_TN_knn_3.drop(['knn_pre','match'], axis=1)
TP_TN_knn_3.to_csv('C:/Users/acer/Downloads/11/3rd_iteration/TN_TP_3.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_3))
...
train4=pd.read_csv("C:/Users/acer/Downloads/11/Train.CSV")
test4=pd.read_csv("C:/Users/acer/Downloads/11/4th_iteration/Test_4.csv")

x_train4 =train4[['age','chol','thalach','oldpeak','ca','thal']]
y_train4 = train4[['target']]

x_test4 = test4[['age','chol','thalach','oldpeak','ca','thal']]
...
if (acc_rf_4 > acc_naive_4 and acc_rf_4 > acc_gb_4) or (acc_rf_4==acc_naive_4 and acc_rf_4>acc_gb_4) or (acc_rf_4==acc_gb_4 and acc_rf_4>acc_naive_4) or (acc_naive_4==acc_gb_4 and acc_rf_4>acc_naive_4):
    ...
    FP_FN_RF_4.to_csv('C:/Users/acer/Downloads/11/5th_iteration/Test_5.CSV')
    print("RF Provides best accuracy")
    print("rf_FP_FN: ",len(FP_FN_RF_4))
    
    TP_TN_RF_4=test4[test4['match']=='True']
    TP_TN_RF_4.to_csv('C:/Users/acer/Downloads/11/4st_iteration/4.CSV')
    TP_TN_RF_4=TP_TN_RF_4.drop(['rf_pre','match'], axis=1)
    TP_TN_RF_4.to_csv('C:/Users/acer/Downloads/11/4th_iteration/TN_TP_4.CSV')
    ...
    FP_FN_Na_4.to_csv('C:/Users/acer/Downloads/11/5th_iteration/Test_5.CSV')
    print("Naive Bayes Provides best accuracy")
    print("na_FP_FN: ",len(FP_FN_Na_4))
    
    TP_TN_Na_4=test4[test4['match']=='True']
    TP_TN_Na_4.to_csv('C:/Users/acer/Downloads/11/4th_iteration/4.CSV')
    TP_TN_Na_4=TP_TN_Na_4.drop(['nb_pre','match'], axis=1)
    TP_TN_Na_4.to_csv('C:/Users/acer/Downloads/11/4th_iteration/TN_TP_4.CSV')
    ...
    FP_FN_gb_4.to_csv('C:/Users/acer/Downloads/11/5th_iteration/Test_5.CSV')
    print("GB Provides best accuracy: ")
    print("gb_FP_FN: ",len(FP_FN_gb_4))
    
    TP_TN_gb_4=test4[test4['match']=='True']
    TP_TN_gb_4.to_csv('C:/Users/acer/Downloads/11/4th_iteration/4.CSV')
    TP_TN_gb_4=TP_TN_gb_4.drop(['gb_pre','match'], axis=1)
    TP_TN_gb_4.to_csv('C:/Users/acer/Downloads/11/4th_iteration/TN_TP_4.CSV')
