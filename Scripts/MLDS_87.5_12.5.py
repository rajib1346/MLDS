...
train1=pd.read_csv("E:/Train.CSV")
...
train2=pd.read_csv("E:/Train.CSV")
...
train3=pd.read_csv("E:/Train.CSV")
...
train4=pd.read_csv("E:/Train.CSV")
...
train5=pd.read_csv("E:/Train.CSV")
...
train6=pd.read_csv("E:/Train.CSV")
...
train7=pd.read_csv("E:/Train.CSV")
...
if acc_rf_7 > acc_naive_7 and acc_rf_7 > acc_gb_7 :
    ...
    FP_FN_Na_7=test5[test7['match']=='False']
...
train8=pd.read_csv("E:/Train.CSV")
...
train9=pd.read_csv("E:/Train.CSV")
...
train10=pd.read_csv("E:/Train.CSV")
...
train11=pd.read_csv("E:/Train.CSV")
...
train12=pd.read_csv("E:/Train.CSV")
...
train13=pd.read_csv("E:/Train.CSV")
...
train14=pd.read_csv("E:/Train.CSV")
...
train15=pd.read_csv("E:/Train.CSV")
...
train16=pd.read_csv("E:/Train.CSV")
...
train17=pd.read_csv("E:/Train.CSV")
...
train18=pd.read_csv("E:/Train.CSV")
...
train19=pd.read_csv("E:/Train.CSV")
...
train20=pd.read_csv("E:/Train.CSV")
...
train21=pd.read_csv("E:/Train.CSV")
...
train22=pd.read_csv("E:/Train.CSV")
...
train23=pd.read_csv("E:/Train.CSV")
...
train24=pd.read_csv("E:/Train.CSV")
...
knn.fit(x_train24,y_train24)
knn_24=knn.predict(x_test24)
acc_knn_24=metrics.accuracy_score(y_test24,knn_24)*100

print("Train_size:",len(train24),"| Test_size:",len(test24))
print("Knn:",acc_knn_24)


test24['knn_pre']=knn_24
test24['match'] = np.where(test24['target'] == test24['knn_pre'], 'True', 'False')
FP_FN_knn_24=test24[test24['match']=='False']
FP_FN_knn_24=FP_FN_knn_24.drop(['knn_pre','match'], axis=1)
FP_FN_knn_24.to_csv('E:/25th_iteration/Test_25.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_24))
    
TP_TN_knn_24=test24[test24['match']=='True']
TP_TN_knn_24.to_csv('E:/24th_iteration/24.CSV')
TP_TN_knn_24=TP_TN_knn_24.drop(['knn_pre','match'], axis=1)
TP_TN_knn_24.to_csv('E:/24th_iteration/TN_TP_24.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_24))
...
train25=pd.read_csv("E:/Train.CSV")
...
train26=pd.read_csv("E:/Train.CSV")
...
train27=pd.read_csv("E:/Train.CSV")
...
train28=pd.read_csv("E:/Train.CSV")
...
train29=pd.read_csv("E:/Train.CSV")
...
train30=pd.read_csv("E:/Train.CSV")
...
knn_30=knn.predict(x_test30)
acc_knn_30=metrics.accuracy_score(y_test30,knn_30)*100

print("Train_size:",len(train30),"| Test_size:",len(test30))
print("Knn:",acc_knn_30)


test30['knn_pre']=knn_30
test30['match'] = np.where(test30['target'] == test30['knn_pre'], 'True', 'False')
FP_FN_knn_30=test30[test30['match']=='False']
FP_FN_knn_30=FP_FN_knn_30.drop(['knn_pre','match'], axis=1)
FP_FN_knn_30.to_csv('E:/31th_iteration/Test_31.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_30))
    
TP_TN_knn_30=test30[test30['match']=='True']
TP_TN_knn_30.to_csv('E:/30th_iteration/30.CSV')
TP_TN_knn_30=TP_TN_knn_30.drop(['knn_pre','match'], axis=1)
TP_TN_knn_30.to_csv('E:/30th_iteration/TN_TP_30.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_30))
...
train31=pd.read_csv("E:/Train.CSV")
...
knn_31=knn.predict(x_test31)
acc_knn_31=metrics.accuracy_score(y_test31,knn_31)*100

print("Train_size:",len(train31),"| Test_size:",len(test31))
print("Knn:",acc_knn_31)


test31['knn_pre']=knn_31
test31['match'] = np.where(test31['target'] == test31['knn_pre'], 'True', 'False')
FP_FN_knn_31=test31[test31['match']=='False']
FP_FN_knn_31=FP_FN_knn_31.drop(['knn_pre','match'], axis=1)
FP_FN_knn_31.to_csv('E:/32th_iteration/Test_32.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_31))
    
TP_TN_knn_31=test31[test31['match']=='True']
TP_TN_knn_31.to_csv('E:/31th_iteration/31.CSV')
TP_TN_knn_31=TP_TN_knn_31.drop(['knn_pre','match'], axis=1)
TP_TN_knn_31.to_csv('E:/31th_iteration/TN_TP_31.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_31))
...
train32=pd.read_csv("E:/Train.CSV")
...
knn_32=knn.predict(x_test32)
acc_knn_32=metrics.accuracy_score(y_test32,knn_32)*100

print("Train_size:",len(train32),"| Test_size:",len(test32))
print("Knn:",acc_knn_32)


test32['knn_pre']=knn_32
test32['match'] = np.where(test32['target'] == test32['knn_pre'], 'True', 'False')
FP_FN_knn_32=test32[test32['match']=='False']
FP_FN_knn_32=FP_FN_knn_32.drop(['knn_pre','match'], axis=1)
FP_FN_knn_32.to_csv('E:/33th_iteration/Test_33.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_32))
    
TP_TN_knn_32=test32[test32['match']=='True']
TP_TN_knn_32.to_csv('E:/32th_iteration/32.CSV')
TP_TN_knn_32=TP_TN_knn_32.drop(['knn_pre','match'], axis=1)
TP_TN_knn_32.to_csv('E:/32th_iteration/TN_TP_32.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_32))
...
train33=pd.read_csv("E:/Train.CSV")
...
knn.fit(x_train33,y_train33)
knn_33=knn.predict(x_test33)
acc_knn_33=metrics.accuracy_score(y_test33,knn_33)*100

print("Train_size:",len(train33),"| Test_size:",len(test33))
print("Knn:",acc_knn_33)


test33['knn_pre']=knn_33
test33['match'] = np.where(test33['target'] == test33['knn_pre'], 'True', 'False')
FP_FN_knn_33=test33[test33['match']=='False']
FP_FN_knn_33=FP_FN_knn_33.drop(['knn_pre','match'], axis=1)
FP_FN_knn_33.to_csv('E:/34th_iteration/Test_34.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_33))
    
TP_TN_knn_33=test33[test33['match']=='True']
TP_TN_knn_33.to_csv('E:/33th_iteration/33.CSV')
TP_TN_knn_33=TP_TN_knn_33.drop(['knn_pre','match'], axis=1)
TP_TN_knn_33.to_csv('E:/33th_iteration/TN_TP_33.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_33))
...
train34=pd.read_csv("E:/Train.CSV")
...
knn.fit(x_train34,y_train34)
knn_34=knn.predict(x_test34)
acc_knn_34=metrics.accuracy_score(y_test34,knn_34)*100

print("Train_size:",len(train34),"| Test_size:",len(test34))
print("Knn:",acc_knn_34)


test34['knn_pre']=knn_34
test34['match'] = np.where(test34['target'] == test34['knn_pre'], 'True', 'False')
FP_FN_knn_34=test34[test34['match']=='False']
FP_FN_knn_34=FP_FN_knn_34.drop(['knn_pre','match'], axis=1)
FP_FN_knn_34.to_csv('E:/35th_iteration/Test_35.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_34))
    
TP_TN_knn_34=test34[test34['match']=='True']
TP_TN_knn_34.to_csv('E:/34th_iteration/34.CSV')
TP_TN_knn_34=TP_TN_knn_34.drop(['knn_pre','match'], axis=1)
TP_TN_knn_34.to_csv('E:/34th_iteration/TN_TP_34.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_34))
...
train35=pd.read_csv("E:/Train.CSV")
...
knn.fit(x_train35,y_train35)
knn_35=knn.predict(x_test35)
acc_knn_35=metrics.accuracy_score(y_test35,knn_35)*100

print("Train_size:",len(train35),"| Test_size:",len(test35))
print("Knn:",acc_knn_35)


test35['knn_pre']=knn_35
test35['match'] = np.where(test35['target'] == test35['knn_pre'], 'True', 'False')
FP_FN_knn_35=test35[test35['match']=='False']
FP_FN_knn_35=FP_FN_knn_35.drop(['knn_pre','match'], axis=1)
FP_FN_knn_35.to_csv('E:/36th_iteration/Test_36.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_35))
    
TP_TN_knn_35=test35[test35['match']=='True']
TP_TN_knn_35.to_csv('E:/35th_iteration/35.CSV')
TP_TN_knn_35=TP_TN_knn_35.drop(['knn_pre','match'], axis=1)
TP_TN_knn_35.to_csv('E:/35th_iteration/TN_TP_35.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_35))
...
train36=pd.read_csv("E:/Train.CSV")
...
knn.fit(x_train36,y_train36)
knn_36=knn.predict(x_test36)
acc_knn_36=metrics.accuracy_score(y_test36,knn_36)*100

print("Train_size:",len(train36),"| Test_size:",len(test36))
print("Knn:",acc_knn_36)


test36['knn_pre']=knn_36
test36['match'] = np.where(test36['target'] == test36['knn_pre'], 'True', 'False')
FP_FN_knn_36=test36[test36['match']=='False']
FP_FN_knn_36=FP_FN_knn_36.drop(['knn_pre','match'], axis=1)
FP_FN_knn_36.to_csv('E:/37th_iteration/Test_37.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_36))
    
TP_TN_knn_36=test36[test36['match']=='True']
TP_TN_knn_36.to_csv('E:/36th_iteration/36.CSV')
TP_TN_knn_36=TP_TN_knn_36.drop(['knn_pre','match'], axis=1)
TP_TN_knn_36.to_csv('E:/36th_iteration/TN_TP_36.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_36))
...
train37=pd.read_csv("E:/Train.CSV")
...
train38=pd.read_csv("E:/Train.CSV")
...
train39=pd.read_csv("E:/Train.CSV")
...
train40=pd.read_csv("E:/Train.CSV")
...
train41=pd.read_csv("E:/Train.CSV")
...
train42=pd.read_csv("E:/Train.CSV")
...
train43=pd.read_csv("E:/Train.CSV")
...
train44=pd.read_csv("E:/Train.CSV")
test44=pd.read_csv("E:/44th_iteration/Test_44.csv")

x_train44 =train44[['age','cholesterol','weight','gluc','ap_lo','ap_hi']]
y_train44 = train44[['target']]

x_test44 = test44[['age','cholesterol','weight','gluc','ap_lo','ap_hi']]
y_test44 = test44[['target']]


knn = KNeighborsClassifier(n_neighbors=1)
knn.fit(x_train44,y_train44)
knn_44=knn.predict(x_test44)
acc_knn_44=metrics.accuracy_score(y_test44,knn_44)*100

print("Train_size:",len(train44),"| Test_size:",len(test44))
print("Knn:",acc_knn_44)


test44['knn_pre']=knn_44
test44['match'] = np.where(test44['target'] == test44['knn_pre'], 'True', 'False')
FP_FN_knn_44=test44[test44['match']=='False']
FP_FN_knn_44=FP_FN_knn_44.drop(['knn_pre','match'], axis=1)
FP_FN_knn_44.to_csv('E:/45th_iteration/Test_45.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_44))
    
TP_TN_knn_44=test44[test44['match']=='True']
TP_TN_knn_44.to_csv('E:/44th_iteration/44.CSV')
TP_TN_knn_44=TP_TN_knn_44.drop(['knn_pre','match'], axis=1)
TP_TN_knn_44.to_csv('E:/44th_iteration/TN_TP_44.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_44))
...
train45=pd.read_csv("E:/Train.CSV")
test45=pd.read_csv("E:/45th_iteration/Test_45.csv")

x_train45 =train45[['age','cholesterol','weight','gluc','ap_lo','ap_hi']]
y_train45 = train45[['target']]

x_test45 = test45[['age','cholesterol','weight','gluc','ap_lo','ap_hi']]
y_test45 = test45[['target']]


knn = KNeighborsClassifier(n_neighbors=1)
knn.fit(x_train45,y_train45)
knn_45=knn.predict(x_test45)
acc_knn_45=metrics.accuracy_score(y_test45,knn_45)*100

print("Train_size:",len(train45),"| Test_size:",len(test45))
print("Knn:",acc_knn_45)


test45['knn_pre']=knn_45
test45['match'] = np.where(test45['target'] == test45['knn_pre'], 'True', 'False')
FP_FN_knn_45=test45[test45['match']=='False']
FP_FN_knn_45=FP_FN_knn_45.drop(['knn_pre','match'], axis=1)
FP_FN_knn_45.to_csv('E:/46th_iteration/Test_46.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_45))
    
TP_TN_knn_45=test45[test45['match']=='True']
TP_TN_knn_45.to_csv('E:/45th_iteration/45.CSV')
TP_TN_knn_45=TP_TN_knn_45.drop(['knn_pre','match'], axis=1)
TP_TN_knn_45.to_csv('E:/45th_iteration/TN_TP_45.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_45))
...
train46=pd.read_csv("E:/Train.CSV")
test46=pd.read_csv("E:/46th_iteration/Test_46.csv")

x_train46 =train46[['age','cholesterol','weight','gluc','ap_lo','ap_hi']]
y_train46 = train46[['target']]

x_test46 = test46[['age','cholesterol','weight','gluc','ap_lo','ap_hi']]
y_test46 = test46[['target']]


knn = KNeighborsClassifier(n_neighbors=1)
knn.fit(x_train46,y_train46)
knn_46=knn.predict(x_test46)
acc_knn_46=metrics.accuracy_score(y_test46,knn_46)*100

print("Train_size:",len(train46),"| Test_size:",len(test46))
print("Knn:",acc_knn_46)


test46['knn_pre']=knn_46
test46['match'] = np.where(test46['target'] == test46['knn_pre'], 'True', 'False')
FP_FN_knn_46=test46[test46['match']=='False']
FP_FN_knn_46=FP_FN_knn_46.drop(['knn_pre','match'], axis=1)
FP_FN_knn_46.to_csv('E:/47th_iteration/Test_47.CSV')
print("knn_FP_FN: ",len(FP_FN_knn_46))
    
TP_TN_knn_46=test46[test46['match']=='True']
TP_TN_knn_46.to_csv('E:/46th_iteration/46.CSV')
TP_TN_knn_46=TP_TN_knn_46.drop(['knn_pre','match'], axis=1)
TP_TN_knn_46.to_csv('E:/46th_iteration/TN_TP_46.CSV')
print("knn_TN_TP: ",len(TP_TN_knn_46))
